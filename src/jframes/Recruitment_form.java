 ...
 * @author ABS
 */
public class Recruitment_form extends javax.swing.JFrame {

    /**
     * Creates new form Recruitment_form
     */
    ...
    private void initComponents() {
        ...
        Table_recruitment = new rojeru_san.complementos.RSTableMetro();
        ...
        Table_recruitment.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        Table_recruitment.setColorBackgoundHead(new java.awt.Color(102, 102, 255));
        Table_recruitment.setColorBordeFilas(new java.awt.Color(102, 102, 255));
        Table_recruitment.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        Table_recruitment.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 25)); // NOI18N
        Table_recruitment.setFuenteFilas(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        Table_recruitment.setFuenteFilasSelect(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        Table_recruitment.setFuenteHead(new java.awt.Font("Yu Gothic UI Semibold", 1, 20)); // NOI18N
        Table_recruitment.setRowHeight(40);
        Table_recruitment.getTableHeader().setReorderingAllowed(false);
        Table_recruitment.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Table_recruitmentMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(Table_recruitment);
        ...
        ManageEmployee.setText("Manage Recruiment");
        ...
        setSize(new java.awt.Dimension(2000, 824));
    ...
    private void txtNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNameActionPerformed
        ...
        int id = Integer.parseInt(Table_recruitment.getValueAt(Table_recruitment.getSelectedRow(),0).toString());
        int score = Integer.parseInt(txt_score.getText());
        Recruitment c1 = new Recruitment(txtName.getText(),txt_education.getText(),txt_skills.getText(),score,txt_comments.getText());
        c1.Delete(id);
    ...
    private void Table_recruitmentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Table_recruitmentMouseClicked
        // TODO add your handling code here:
        int id = Integer.parseInt(Table_recruitment.getValueAt(Table_recruitment.getSelectedRow(),0).toString());
        try{
    ...
    }//GEN-LAST:event_Table_recruitmentMouseClicked
    ...
    String[] columnName = {"ID", "Candidate Name", "Candidate Education", "Skills ","Test Scores","Interviewer's Comment"};
    DefaultTableModel model = (DefaultTableModel) Table_recruitment.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Recruitment_form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Recruitment_form().setVisible(true);
            }
        });
    }
    ...
    private rojeru_san.complementos.RSTableMetro Table_recruitment;
